...
// Description: Uses makeNode () to allocate space for a new Node and inserts the new Node 
//              into the list in alphabetic order ('a' - 'z')based on the name field
...
// What do we do when we're done with the list?